...
- **用途：** 定时任务每次取「待写」前 5 条写入 `content/traditions/`
- **结构：** 对齐现有传统卡（概述／核心观念／典型仪式／日常与节庆／注意与尊重／手机互动适合度／参考来源）
- **规则：** 不与已有卡重复造同主题；与 `shinto.md`／`celtic-folk.md` 等重叠时交叉引用、专卡聚焦物件／短互动；来源≥2 条可核验链接；标 A/B/C；禁止编造
- **依据：** `specs/2026-09-20-daily-micro-rituals-candidates.md`、`specs/2026-09-21-daily-micro-rituals-candidates-b2.md`、附注 notes
